...
import {
  ...
  FileSearch, Film, Folder, Gauge, Image as ImageIcon, Lightbulb, MapPin, Play, ShieldCheck,
...
export default function ControlRoomLandingPage() {
  ...
  return <div className={styles.content}>
    ...
    <p className={styles.subtitle}>
      ...
      Start or stop the entire system here (or from the persistent top bar). Stages advance automatically while Running.
    </p>

    <SystemControlBar variant="landing" onChanged={() => void refresh()} />

    <section className={styles.controlBar} style={{ marginTop: 14 }}>
